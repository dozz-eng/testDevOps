...
Отличия мониторинга и логгирования: 
    ...
    Логи могут использоваться и в реальном времени, например система может отслеживать логи, связанные со входом пользователя в систему и информировать пользователя о попытках несанкционированного проникновения.
